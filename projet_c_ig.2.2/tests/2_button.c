...
int ei_main(int argc, char** argv)
{
	...
	ei_size_t	button_size		= {300,200};
        ei_size_t       button_size2            = {300,200}; 
	int		button_x		= 150;
	int		button_y		= 100;
        int             button_x2               = 150;
        int             button_y2               = 300;
	ei_color_t	button_color		= {0x88, 0x88, 0x88, 0xff};
        ei_color_t	button_color2		= {0x72, 0x9c, 0x15, 0xff};
	char*		button_title		= "Mon premier Bouton !";
        char*           button_title2           = "BOUTON !!!";
	ei_color_t	button_text_color	= {0x00, 0x00, 0x00, 0xff};
        ei_color_t	button_text_color2	= {0xff, 0x00, 0x00, 0xff};
	...
	ei_button_configure	(button, &button_size, &button_color,
        ...
        ei_button_configure      (button2, &button_size2, &button_color2,
                                 &button_border_width, &button_corner_radius, &button_relief, &button_title2, NULL, &button_text_color2, NULL,
                                 NULL, NULL, NULL, &button_callback, NULL);
